...
#define CUSTOM_ABILITIES_ENDS       ABILITY_CHLOROPLAST
...
#define PASSIVE_ABILITY_PSYCHIC         (CUSTOM_ABILITIES_ENDS + 4)

#define PASSIVE_ABILITIES_ENDS      PASSIVE_ABILITY_PSYCHIC
