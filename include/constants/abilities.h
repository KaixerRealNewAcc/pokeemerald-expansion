...
#define ABILITY_CHLOROPLAST         (ABILITIES_COUNT_GEN9 + 14)
#define ABILITY_SHORT_CIRCUIT       (ABILITIES_COUNT_GEN9 + 15)
#define ABILITY_POISON_ABSORB       (ABILITIES_COUNT_GEN9 + 16)
#define ABILITY_METAL_FUR           (ABILITIES_COUNT_GEN9 + 17)
#define ABILITY_KEEN_EDGE           (ABILITIES_COUNT_GEN9 + 18)
#define ABILITY_FREEZING_MELODY     (ABILITIES_COUNT_GEN9 + 19)

#define CUSTOM_ABILITIES_ENDS       ABILITY_FREEZING_MELODY 
#define PASSIVE_ABILITIES_BEGIN     CUSTOM_ABILITIES_ENDS

//Passive Abilities Defines that leech off existing Abilities.
#define PASSIVE_ABILITY_STURDY          ABILITY_STURDY
#define PASSIVE_ABILITY_CHLOROPLAST     ABILITY_CHLOROPLAST
#define PASSIVE_ABILITY_SHORT_CIRCUIT   ABILITY_SHORT_CIRCUIT
#define PASSIVE_ABILITY_POISON_ABSORB   ABILITY_POISON_ABSORB
#define PASSIVE_ABILITY_METAL_FUR       ABILITY_METAL_FUR
#define PASSIVE_ABILITY_KEEN_EDGE       ABILITY_KEEN_EDGE 

#define PASSIVE_ABILITY_CORV_SLAYER     (CUSTOM_ABILITIES_ENDS + 1)
#define PASSIVE_ABILITY_SELF_SUFFICIENT (CUSTOM_ABILITIES_ENDS + 2)
#define PASSIVE_ABILITY_ERUPTIVE_BACK   (CUSTOM_ABILITIES_ENDS + 3)
#define PASSIVE_ABILITY_FIGHTING_SPIRIT (CUSTOM_ABILITIES_ENDS + 4)
#define PASSIVE_ABILITY_DAZZLING_FEATHERS (CUSTOM_ABILITIES_ENDS + 5)
#define PASSIVE_ABILITY_MONKEY_HANDS    (CUSTOM_ABILITIES_ENDS + 6)

//Calc typing shit, its a shit method of implementing the ability, but till i have the time to add it manuall this is the next best bet.
#define PASSIVE_ABILITY_NOISE_CANCEL (ABILITY_SOUNDPROOF + PASSIVE_ABILITY_MONKEY_HANDS)

#define PASSIVE_ABILITIES_ENDS      PASSIVE_ABILITY_NOISE_CANCEL

#define ABILITIES_COUNT_CUSTOM      (PASSIVE_ABILITIES_ENDS + 1)
