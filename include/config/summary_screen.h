...
#define MAX_ABILITY_DESCRIPTION_LENGTH 100 //The maximum length of the ability description string.
#define MAX_ABILITY_DESCRIPTION_WIDTH  154 //The maximum width of the ability description string.
