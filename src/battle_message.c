...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_PKMNPREVENTSPARALYSISWITH]            = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX}'s ability prevents paralysis!"), //not in gen 5+, ability popup
    ...
    [STRINGID_PKMNPREVENTSPOISONINGWITH]            = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX}'s ability prevents poisoning!"), //not in gen 5+, ability popup
    ...
    [STRINGID_PKMNSXHADNOEFFECTONY]                 = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s ability had no effect on {B_EFF_NAME_WITH_PREFIX2}!"), //not in gen 5+, ability popup
    ...
    [STRINGID_ENDUREDSTURDY]                        = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} endured the hit using its ability!"),
    ...
    [STRINGID_PKMNSABILITYRESTOREDHPALITTLE]        = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}'s ability restored its HP a little"),
    [STRINGID_BATTLERADDEDTHETYPE]                  = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} added the {B_BUFF2}-type!"),
};
