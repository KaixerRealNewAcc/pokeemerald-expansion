...
const struct SpeciesInfo gSpeciesInfoGen3[] =
{
    ...
    [SPECIES_SCEPTILE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_OVERGROW, ABILITY_TECHNICIAN, ABILITY_UNBURDEN },
        .passiveAbility = PASSIVE_ABILITY_CHLOROPLAST,
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_SCEPTILE_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_LIGHTNING_ROD, ABILITY_TECHNICIAN, ABILITY_LIGHTNING_ROD },
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = _("Sceptile"),
...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_NUMEL] =
    {
        ...
        .passiveAbility = ABILITY_MAGMA_ARMOR,
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Numel"),
        .cryId = CRY_NUMEL,
    ...
    [SPECIES_CAMERUPT] =
    {
        ...
        .passiveAbility = PASSIVE_ABILITY_ERUPTIVE_BACK,
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_FLYGON] =
    {
        ...
        .passiveAbility = ABILITY_SAND_SONG,
        .bodyColor = BODY_COLOR_GREEN,
